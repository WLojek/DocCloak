  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 min-h-[200px] p-4 text-foreground text-sm leading-relaxed whitespace-pre-wrap font-light">
        ...
        ) : value ? renderHighlighted() : (
          <div className="flex flex-col items-center justify-center h-full min-h-[160px] text-center">
            <ArrowLeft className="w-6 h-6 text-muted-foreground/40 mb-3 hidden md:block" />
            <span className="text-muted-foreground text-xs font-sans">{t.textOutput.emptyStateHint}</span>
          </div>
        )}
      </div>
